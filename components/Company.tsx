...
export default function Company() {
    return (
        <div className="">
            <div className="relative mt-12 grid gap-6 md:grid-cols-1 lg:grid-cols-1">
                {/* <Card> */}
                    ...
                    <div>
                        ...
                        <p className="mt-3 text-lg text-gray-600 dark:text-gray-400">Our buyers have changed the way they buy, but we haven't evolved our sales strategies, workflows, and technologies to match their preferences. The old way of sales engagement — relying on templates and manual efforts to scale — won't cut it anymore.</p>
                    </div>
                {/* </Card> */}
                {/* <Card> */}
                    ...
                    <div>
                        ...
                        <p className="mt-3 text-lg text-gray-600 dark:text-gray-400"> We need a new way - one powered by generative AI - to find and qualify prospects, engage with high impact, and execute dynamic touch patterns in a buyer-centric way. JumpQ is committed to owning the entire journey for your success, providing you with an unparalleled advantage. You. Amplified.</p>
                    </div>
                {/* </Card> */}
                {/* <Card>
