export default function Feature({title, description, children}: {title: string; description: string, children: any}) {
  return (
    <div className="flex flex-col gap-6 rounded-2xl p-4 transition duration-300 hover:bg-white hover:shadow-2xl hover:shadow-gray-600/10 dark:hover:bg-gray-700/60 dark:hover:shadow-none">
