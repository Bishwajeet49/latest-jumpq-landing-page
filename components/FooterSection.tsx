    ...
    return (
        <footer className="bg-gradient-to-b from-transparent to-gray-100 py-12 dark:to-gray-900">
            <Container>
                ...
                {/* Contact Section */}
                <div className="mt-8 flex flex-wrap justify-center gap-6 space-x-8 text-gray-600 dark:text-gray-400">
                    <div className="flex flex-col gap-05 items-center text-center">
                        <span className="font-medium">📍 Address</span>
                        <span className="text-wrap">123 Street Name, City, Country</span>
                    </div>
                    <div className="flex flex-col gap-05 items-center text-center">
