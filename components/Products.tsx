    ...
    return (
        <div className="my-20 md:my-32">
            ...
            <div className="relative mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                <Card>
                    <Image className="w-10" src="/images/Efficiency icon.png" alt="safety icon illustration" height="512" width="512" />
                    <div>
                ...
                <Card>
                    <Image className="w-10" src="/images/Superhuman icon.png" alt="payment card icon illustration" height="512" width="512" />
                    <div>
                ...
                <Card>
                    <Image className="w-10" src="/images/Infinite icon.png" alt="xp icon illustration" height="512" width="512" />
                    <div>
